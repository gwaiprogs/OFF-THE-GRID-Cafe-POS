...
//RETRIEVE CART DATA FROM SESSION (FROM ORDER PAGE)
...
// IF CART IS EMPTY, GO BACK TO ORDER PAGE
if (empty($cartData)) {
...
<div class="payment-container">
    ...
    <div class="logo-header">
        <img src="../../photos/OTG-GREEN-1.png" alt="OFF-THE-GRID Logo" style="max-width: 150px; height: auto;">
